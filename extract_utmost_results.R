...
#a = as.data.frame(fread(paste0(paste0(utmost_results, '/joint/'), dir(paste0(utmost_results, '/joint/'))[1]), header=T, sep="\t"))
a = as.data.frame(fread(utmost_results, header=T, sep="\t"))
